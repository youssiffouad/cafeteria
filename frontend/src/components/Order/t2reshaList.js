...
const T2reshaList = () => {
  ...
  return (
    <OrderItemProvider>
      <h2 className="text-center tableTitlefont">عرض كل التقريشة</h2>
      <table
      ...
      >
        <thead>
          <tr>
            ...
            <th className="col-md-2 tableHeadfont">الرتبة / الدرجة</th>
            <th className="col-md-2 tableHeadfont">اسم المستهلك</th>
            <th className="col-md-2 tableHeadfont">تاريخ الطلب</th>
